 ...
 *
 * Инициализацию соединение с БД произвести один раз перед началом тестов, после завершения всех тестов, закрыть соединение с БД
 *
...
public class Tests {
    ...
    static PreparedStatement pst1 = null, pst2 = null, pst3 = null;
    /**
